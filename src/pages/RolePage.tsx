...
export const RolesPage: React.FC = () => {
    ...
    const handleDeleteRole = (role: Role) => {
        ...
        if (['super_admin', 'admin', 'manager', 'sales_rep', 'viewer'].includes(role.name)) {
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-3xl font-bold text-gray-900">
                                {roles.filter(r => !['super_admin', 'admin', 'manager', 'sales_rep', 'viewer'].includes(r.name)).length}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                {roles.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
                        {roles.map((role) => {
                            ...
                            const isSystemRole = ['super_admin', 'admin', 'manager', 'sales_rep', 'viewer'].includes(role.name);
                                ...
                                <div key={role.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                                    ...
                                    <div className="space-y-3 mb-4">
                                        ...
                                        {Object.keys(permissionsByModule).length === 0 && (
                                            <p className="text-sm text-gray-500 italic">Sin permisos asignados</p>
                                        )}
                                    </div>
